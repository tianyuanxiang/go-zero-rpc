...
func (m *defaultSysUserModel) Insert(ctx context.Context, data *SysUser) (sql.Result, error) {
	query := fmt.Sprintf("insert into %s (%s) values ($1, $2, $3, $4, $5, $6, $7, $8, $9)", m.table, sysUserRowsExpectAutoSet)
...
func (m *defaultSysUserModel) Update(ctx context.Context, newData *SysUser) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, newData.Id, newData.Username, newData.Password, newData.Nickname, newData.Email, newData.Phone, newData.Avatar, newData.Status, newData.Remark, newData.DeletedAt)
	return err
}
